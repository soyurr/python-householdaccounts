...
class MyFrame1 ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.comboAccount = wx.ComboBox( self, wx.ID_ANY, u"선택!!", wx.DefaultPosition, wx.DefaultSize, comboAccountChoices, 0 )
        ...
        self.m_button8 = wx.Button( self.panel, wx.ID_ANY, u"수입/지출", wx.DefaultPosition, wx.DefaultSize, 0|wx.NO_BORDER )
        self.m_button8.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_ACTIVEBORDER ) )
        
        
        #임의 추가
        self.m_button10 = wx.Button( self.panel, wx.ID_ANY, u"계정과목", wx.DefaultPosition, wx.DefaultSize, 0|wx.NO_BORDER )
        self.m_button10.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_ACTIVEBORDER ) )
        # self.m_button11 = wx.Button( self.panel, wx.ID_ANY, u"기간별", wx.DefaultPosition, wx.DefaultSize, 0|wx.NO_BORDER )
        # self.m_button11.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_ACTIVEBORDER ) )        
        ...
        self.m_button4.Bind( wx.EVT_BUTTON, self.btnSelect )
        ...
        self.m_button10.Bind( wx.EVT_BUTTON, self.OnDrawButton2 )
        # self.m_button11.Bind( wx.EVT_BUTTON, self.btnSelect )
    ...
    def btnSelect( self, event ):
        ...
        try:
            ...
            for row in rows:
                ...
                지출 += row[6]
                x += 1
            self.txtRevenue.SetLabel(str(수입))
            self.txtExpense.SetLabel(str(지출))
    ...
    def OnDrawButton2( self, event ):   
        firstDate = str(self.txtStart.GetValue())
        secondDate = str(self.txtEnd.GetValue())   
        rows = homebookSqliteCRUD.selectDate(firstDate, secondDate)
